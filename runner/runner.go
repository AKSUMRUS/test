...
// Runner realises logic of program execution on a virtual machine.
type Runner struct {
...
func main() {
	...
	if err := runner.client.Call("Analyzer.NextProgram", &syz_analyzer.ProgramArgs{Pool: runner.pool, VM: runner.vm, TaskID: ""}, res); err != nil {
...
// Run returns results of task execution and gets next program.
func (runner *Runner) Run(firstProgram []byte, taskID string) {
